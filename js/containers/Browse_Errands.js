    ...
    for(var errandID in this.props.userErrandsDatabaseAdmin[0]){
      ...
      errandsArray.push(
        ...
        <div key={errandID} className="container">
          <h1>Elev: </h1><h2>{this.props.userErrandsDatabaseAdmin[0][errandID].basicInfo.student.name}</h2>
          <h1>Lärare: </h1><h2>{this.props.userErrandsDatabaseAdmin[0][errandID].basicInfo.teacher.name}</h2>
        </div>
        </Link>
      )
