    ...
    for(var behaviorID in this.props.userErrandDetailsDatabaseAdmin[0].behavior){
      ...
      behaviorArray.push(
        <div key={behaviorID}>
          ...
          {this.props.userErrandDetailsDatabaseAdmin[0].behavior[behaviorID].rulesIssue === true ? <p>Svårt att följa de instruktioner eller regler som finns inom givet sammanhanget och hamnar således i konflikt med andra barn eller skolpersonal på grund av detta: {this.props.userErrandDetailsDatabaseAdmin[0].behavior[behaviorID].rulesFrequency}</p> : <p id="hide"></p>}
          {this.props.userErrandDetailsDatabaseAdmin[0].behavior[behaviorID].verbalIssue === true ? <p>Verbal: {this.props.userErrandDetailsDatabaseAdmin[0].behavior[behaviorID].verbalFrequency}</p> : <p id="hide"></p>}
          {this.props.userErrandDetailsDatabaseAdmin[0].behavior[behaviorID].aggressiveIssue === true ? <p>Aggressive: {this.props.userErrandDetailsDatabaseAdmin[0].behavior[behaviorID].aggressiveFrequency}</p> : <p id="hide"></p>}
          {this.props.userErrandDetailsDatabaseAdmin[0].behavior[behaviorID].seclusiveIssue === true ? <p>Seclusive: {this.props.userErrandDetailsDatabaseAdmin[0].behavior[behaviorID].seclusiveFrequency}</p> : <p id="hide"></p>}
          <hr/>
        </div>
      )
